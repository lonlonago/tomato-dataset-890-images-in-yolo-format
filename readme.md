# Tomato dataset 890 images in YOLO format.

# Body

Tomato dataset with 890 images in YOLO format
The images are clear, and the annotations are complete, suitable for training tomato object detection models. It is ready to use directly, saving time and effort
